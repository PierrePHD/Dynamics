#!/bin/sh
	...
	mkdir /data1/nargil/resultats/Tot_JOB
	sed -e "s/%exit/exit/g" Calcul/main.m > TempMain1.m
	
	
	count=1;

	for Tstep in 10 5 # 400 200 100 50 25 #
	do
	...
	for Tcharge in 40 60 80 120 160 200 250
	do
		...
		then
			...
			echo "mkdir /data1/nargil/resultats/JOB_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}/" >> job
			echo "mkdir /data1/nargil/resultats/JOB_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}/Images/" >> job
			echo "cp /usrtmp/nargil/Calcul_$count/Images/Sortie/*.eps /data1/nargil/resultats/JOB_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}/Images/" >> job
			echo "cp /usrtmp/nargil/Calcul_$count/Images/Sortie/matPGDErreur.png /data1/nargil/resultats/Tot_JOB/Erreur_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}.png" >> job
			echo "cp /usrtmp/nargil/Calcul_$count/Log* /data1/nargil/resultats/JOB_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}/" >> job
			echo "cp /usrtmp/nargil/Calcul_$count/*.mat /data1/nargil/resultats/JOB_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}/Res_cas_${cas}_schem_${schem}_Tcharge_${Tcharge}_Tstep_${Tstep}.mat" >> job
